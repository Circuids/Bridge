...
public sealed class BridgeServiceResolutionBlazorConformanceSuite
{
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public BridgeServiceResolutionBlazorConformanceSuite(IServiceScopeFactory serviceScopeFactory)
    {
